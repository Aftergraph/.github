# .github — Agent Execution Contract

<!-- Generated 2026-09-10 from REPOSITORY_INVENTORY.json, CI_COMMAND_INVENTORY.json, CI_RESULTS.json and a
     live probe of branch main at HEAD e9662a4c638e653ca1ce893ed3f45d44584ebd01. Revision 1.
     NOTE: the workspace inventory recorded main at 56d70aa; this file was generated
     from the live checkout (main at e9662a4c638e653ca1ce893ed3f45d44584ebd01). Re-verify against your SHA.
     Regenerate the command blocks; hand-edit only the Ratchet section. -->

## Project

  Name        .github
  Role        Not declared in the workspace contract — organization profile and org-wide workflows
...
## Local conventions (verified present on disk)
  ...
  Probes
  - pytest files: ./scripts/test_verify_brand_assets.py, ./scripts/test_verify_polyrepo_heads.py
  - verifier scripts: scripts/verify_brand_assets.py, scripts/verify_polyrepo_heads.py
